...
void INICIO(){
	cout<<"	Alumno: Nemesis J. Sierra Aranda 221404306"<<endl<<"	Profesor: José Francisco Reinaga Camacho"<<endl<<"	Carrera: Ingeniería en Computación, 1er Semestre"<<endl<<endl;
...
void INTERCAMBIAR_VALORES(){
	...
	num=0;
	while (num==0){
		cout<<"Seleccione 1 para mostrar X, 2 para Y o 3 para intercambiar, 0 para salir..."<<endl;
		cin>>seleccion;
		switch (seleccion){
			case 1:
